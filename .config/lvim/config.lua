...
vim.g.python_host_prog = "/home/manjaro_kde/armot/.pyenv/shims/python"
vim.g.python3_host_prog = "/home/manjaro_kde/armot/.pyenv/shims/python"
...
lvim.builtin.nvimtree.setup.filters.custom = { "venv", ".venv", "__pycache__", ".git" }
